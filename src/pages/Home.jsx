...
const Home = () => {
  ...
  return (
    <section className="mt-14 lg:mt-2 relative min-h-screen overflow-hidden bg-gradient-to-br from-black via-gray-900 to-indigo-950 text-white flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-block px-3 py-1 rounded-full bg-violet-500 bg-opacity-20 border border-violet-400 text-blue-50 text-xs md:text-sm mb-2"
            >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-200 leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg text-gray-300 max-w-lg mx-auto md:mx-0"
            >
            ...
            >
              {techIcons.map((tech, index) => (
                ...
                >
                  <div className="text-2xl sm:text-3xl p-3 bg-gray-800 bg-opacity-50 rounded-lg backdrop-filter backdrop-blur-sm shadow-lg group-hover:shadow-blue-500/20">
                    {tech.icon}
                  </div>
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                transition={{ type: 'spring', stiffness: 300 }}
                className="bg-transparent border border-gray-400 text-white py-2 px-6 rounded-lg font-medium hover:border-violet-400 text-sm sm:text-base text-center"
              >
                Download Resume
              </motion.a>
            </motion.div>
